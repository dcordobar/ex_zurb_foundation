defmodule Zf.GridTest do
  ...
  test "spawn foundation grid with default tag elements", params do
    ...
    assert expected == Zf.Grid.zf_grid([class: "expanded align-middle"], params[:grid_default])
  ...
  test "spawn foundation grid with custom tag elements", params do
    ...
    assert expected == Zf.Grid.zf_grid([class: "expanded align-middle", tag: :ul], params[:grid_custom])
  ...
  test "spawn foundation grid when content is a list of maps", params do
    ...
    assert expected == Zf.Grid.zf_grid([class: "expanded align-middle"], params[:grid_map])
